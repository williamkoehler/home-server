...
namespace server
{
    namespace api
    {
        ...
        Ref<Resource> DynamicResources::AddResourceFromMemory(std::string prefix, std::string name, uint8_t* data,
                                                              size_t size)
        {
            assert(size > 0);
            assert(data != nullptr);
        ...
        Ref<Resource> DynamicResources::AddResourceFromMemoryWithoutCopy(std::string prefix, std::string name,
        ...
        Ref<Resource> DynamicResources::UpdateResourceFromMemory(std::string prefix, std::string name, uint8_t* data,
                                                                 size_t size)
        {
            assert(size > 0);
            assert(data != nullptr);
        ...
        Ref<Resource> DynamicResources::UpdateResourceFromMemoryWithoutCopy(std::string prefix, std::string name,
                                                                            uint8_t* data, size_t size)
        {
            assert(size > 0);
            assert(data != nullptr);
