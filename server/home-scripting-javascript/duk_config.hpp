/*
 *  duk_config.hpp configuration header generated by genconfig.py.
 *
 ...
 * for user code including duktape.hpp.
 */
...
#define DUK_USE_EXEC_TIMEOUT_CHECK(udata) duk_exec_timeout(udata)
