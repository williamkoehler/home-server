    ...
    namespace scripting
    {
        namespace javascript
        {
            duk_ret_t duk_service_id_constructor(duk_context* context)
            {
                ...
                // Set type
                duk_push_lstring(context, SERVICE_TYPE_NAME, SERVICE_TYPE_NAME_SIZE);   // [ this number string ]
            ...
            bool duk_new_service_id(duk_context* context, identifier_t id)
            {
                ...
                // New service id object
                duk_get_global_lstring(context, SERVICE_ID_OBJECT, SERVICE_ID_OBJECT_SIZE); // [ func ]
