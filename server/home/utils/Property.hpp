...
namespace home
{
	...
	/// @brief Thread safe property that can be read and written to from mutliple threads. Uses atomic operation and spinlocks
	class Property
	{
	public:
		virtual PropertyType GetType() const = 0;

		inline bool IsBoolean() const { return GetType() == PropertyType::kBooleanType; }
		inline bool IsInteger() const { return GetType() == PropertyType::kIntegerType; }
		inline bool IsNumber() const { return GetType() == PropertyType::kNumberType; }
		inline bool IsString() const { return GetType() == PropertyType::kStringType; }
		inline bool IsEndpoint() const { return GetType() == PropertyType::kEndpointType; }
		inline bool IsColor() const { return GetType() == PropertyType::kColorType; }
