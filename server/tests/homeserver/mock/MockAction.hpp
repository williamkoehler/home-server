...
//};
//
//Ref<server::DeviceController> MockDeviceController(identifier_t id = 1, const std::string& name = "unknown devicecontroller", Ref<home::DeviceControllerPlugin> plugin = nullptr, Ref<server::Room> room = nullptr)
//{
//	if (plugin == nullptr)
