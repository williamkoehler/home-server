...
add_requires("conan::spdlog/1.12.0", { 
    alias = "spdlog",
    configs = {
        settings = {
            "spdlog:compiler=gcc",
...
add_requires("conan::openssl/3.1.1", { alias = "openssl" })
add_requires("conan::boost/1.82.0", { 
    alias = "boost",
    configs = {
        settings = {
            "boost:compiler=gcc",
...
add_requires("conan::sqlite3/3.42.0", { alias = "sqlite3" })
